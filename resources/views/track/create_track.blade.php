...
@section('container')
    ...
    <div class="container">
        <div class="row">
            <div class="col-8">
            <h1 class="mt-2 text-light">Form Tambah Musik</h1>
            <form method="post" action="/track">
            @csrf
                <div class="form-group">
                    <label class="mt-2 text-light" for="track_name">Judul</label>
                    ...
                    <label class="mt-2 text-light" for="track_file">File</label>
